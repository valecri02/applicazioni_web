...
recensioni = [{'id':1, 'recensione': 'Recensione 0'}]
...
def add_recensione():
  ...
  #in url_for indico la funzione a cui voglio essere rediretto: è la funzione che renderizza la pagina
  return redirect(url_for('index'))

# redirigo alla funzione che renderizza la pagina  a cui voglio essere indirizzato
# di modo che anche l'url sia aggiornata
